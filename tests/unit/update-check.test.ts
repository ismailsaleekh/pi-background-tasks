...
void describe('update-check', () => {
  ...
  void it('aborts and returns undefined when the request exceeds the timeout without reporting it as an error', async () => {
    const errors: string[] = [];
    ...
    // The timeout abort is expected, designed behavior: it must be silent, not
    // surfaced through onError as an error.
