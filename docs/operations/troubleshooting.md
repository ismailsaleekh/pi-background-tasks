...
| `pi_executable_resolution_failed` | Windows Pi package bin cannot be resolved/validated | Reinstall/repair Pi package; the error lists module, entry, and host-script attempts. Do not fall back to shell PATH shims. |
